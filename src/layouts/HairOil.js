...
const HairOil = ({ items, getItems, loading }) => {
  ...
  document.title =
    "Hair Oil | Luxury Silk Online, High Quality Hair Products. Nairobi, Kenya.";
  ...
  return (
    <>
      <div className="title">
        ...
        <h2 className="title-name">Hair Oil</h2>
      </div>
...
export default connect(mapStateToProps, { getItems })(HairOil);
